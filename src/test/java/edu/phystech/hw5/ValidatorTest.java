...
public class ValidatorTest {
    ...
    void notBlankWorks() {
        ...
        Assertions.assertDoesNotThrow(() -> validatorImpl.validate(new Example("123", "567")));
        ValidationException exception =
                Assertions.assertThrows(ValidationException.class, () -> validatorImpl.validate(new Example("11", "")));
    ...
    void sizeWorks() {
        ...
        Assertions.assertDoesNotThrow(() -> validatorImpl.validate(new Example("123", "567765")));
        ValidationException exception =
                Assertions.assertThrows(ValidationException.class, () -> validatorImpl.validate(new Example("", "")));
        Assertions.assertEquals("Long live Saint Petersburg!", exception.getMessage());
        Assertions.assertThrows(ValidationException.class, () -> validatorImpl.validate(new Example("", "0000000000000")));
    }
